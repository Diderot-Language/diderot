...
structure LowOps =
  ...
  (* required helper functions for the index control type type *)
    ...
    fun hash IAdd = 0w3
      ...
      | hash Exp = 0w271
      | hash Sign = 0w277
      | hash (Ceiling(a0)) = 0w281 + hashint a0
      | hash (Floor(a0)) = 0w283 + hashint a0
      | hash (Round(a0)) = 0w293 + hashint a0
      | hash (Trunc(a0)) = 0w307 + hashint a0
      | hash IntToReal = 0w311
      | hash (RealToInt(a0)) = 0w313 + hashint a0
      | hash (NumStrands(a0)) = 0w317 + StrandSets.hash a0
      | hash (Strands(a0,a1)) = 0w331 + hashty a0 + StrandSets.hash a1
      | hash (Transform(a0)) = 0w337 + ImageInfo.hash a0
      | hash (Translate(a0)) = 0w347 + ImageInfo.hash a0
      | hash (ControlIndex(a0,a1,a2)) = 0w349 + ImageInfo.hash a0 + hashidxctl a1 + hashint a2
      | hash (LoadVoxel(a0)) = 0w353 + ImageInfo.hash a0
      | hash (Inside(a0,a1)) = 0w359 + ImageInfo.hash a0 + hashint a1
      | hash (IndexInside(a0,a1)) = 0w367 + ImageInfo.hash a0 + hashint a1
      | hash (ImageDim(a0,a1)) = 0w373 + ImageInfo.hash a0 + hashint a1
      | hash (LoadSeq(a0,a1)) = 0w379 + hashty a0 + hashstring a1
      | hash (LoadImage(a0,a1)) = 0w383 + hashty a0 + hashstring a1
      | hash KillAll = 0w389
      | hash StabilizeAll = 0w397
      | hash (Print(a0)) = 0w401 + hashtys a0
      | hash (MathFn(a0)) = 0w409 + MathFns.hash a0
